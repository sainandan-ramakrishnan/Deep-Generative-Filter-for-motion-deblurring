...
opt = {
    ...
    fineSize1 = 256,           --  then crop to this size
    ...
    which_epoch = 'latest',            -- which epoch to test? set to 'latest' to use latest cached model. Ensure that a model starting with 'latest' is in the model folder .
}
